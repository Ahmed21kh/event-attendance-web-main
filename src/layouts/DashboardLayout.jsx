...
const DashboardLayout = () => {
  ...
  const [activeKey, setactiveKey] = useState(location.pathname == '/'?'/add-invite':location.pathname);
    ...
    <Layout hasSider>
      ...
      >
        ...
        <Menu
          ...
          items={items}
          activeKey={location.pathname =='/'?'/add-invite':activeKey}
        />
      </Sider>
      <Layout
        style={{
